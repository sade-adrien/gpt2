"""
Script to resume the training of a GPT2 model using a pre-trained GPT2Tokenizer (re-implemantation).
It needs a local checkpoint to load.
...
def main():
    checkpoint_path = 'weights/model_15160.pt'
    checkpoint = torch.load(checkpoint_path)
    
    model, optimizer = GPT2.from_checkpoint(checkpoint_path, device=device)
